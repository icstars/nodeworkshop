...
function getStub(endpoint, callback){
  ...
  if (endpoint =="/getTrains"){
    stubbedJson = [{"id":1,"name":"stubb redline 813","inservice":true,"numberofavailable":8},{"id":2,"name":"redline 912","inservice":true,"numberofavailable":10},{"id":3,"name":"greenline 713","inservice":true,"numberofavailable":10},{"id":4,"name":"brownline 412","inservice":true,"numberofavailable":8}];
  }
